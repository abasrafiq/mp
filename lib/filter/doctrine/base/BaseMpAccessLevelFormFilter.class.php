...
/**
 * MpAccessLevel filter form base class.
 *
 * @package    MP
 * @subpackage filter
 * @author     abas rafiq
 ...
 */
abstract class BaseMpAccessLevelFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('mp_access_level_filters[%s]');
