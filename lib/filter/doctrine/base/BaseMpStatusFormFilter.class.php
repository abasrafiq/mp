...
/**
 * MpStatus filter form base class.
 *
 * @package    MP
 * @subpackage filter
 * @author     abas rafiq
 ...
 */
abstract class BaseMpStatusFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('mp_status_filters[%s]');
