...
/**
 * MpSession filter form base class.
 *
 * @package    MP
 * @subpackage filter
 * @author     abas rafiq
 ...
 */
abstract class BaseMpSessionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('mp_session_filters[%s]');
