...
/**
 * MpDataSource filter form base class.
 *
 * @package    MP
 * @subpackage filter
 * @author     abas rafiq
 ...
 */
abstract class BaseMpDataSourceFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('mp_data_source_filters[%s]');
