...
/**
 * MpPeriod filter form base class.
 *
 * @package    MP
 * @subpackage filter
 * @author     abas rafiq
 ...
 */
abstract class BaseMpPeriodFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('mp_period_filters[%s]');
