...
/**
 * MpAccessLevel form base class.
 *
 * @method MpAccessLevel getObject() Returns the current form's model object
 *
 * @package    MP
 * @subpackage form
 * @author     abas rafiq
 ...
 */
abstract class BaseMpAccessLevelForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('mp_access_level[%s]');
