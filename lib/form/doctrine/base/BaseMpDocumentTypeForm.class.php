...
/**
 * MpDocumentType form base class.
 *
 * @method MpDocumentType getObject() Returns the current form's model object
 *
 * @package    MP
 * @subpackage form
 * @author     abas rafiq
 ...
 */
abstract class BaseMpDocumentTypeForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('mp_document_type[%s]');
