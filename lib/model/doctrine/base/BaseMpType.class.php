 ...
 * @method MpType              setName()        Sets the current record's "name" value
 * @method MpType              setDescription() Sets the current record's "description" value
 * @method MpType              setStatusId()    Sets the current record's "status_id" value
 * @method MpType              setMpStatus()    Sets the current record's "MpStatus" value
 * @method MpType              setBulkUploads() Sets the current record's "BulkUploads" collection
 * 
 * @package    MP
 * @subpackage model
 * @author     abas rafiq
 ...
 */
abstract class BaseMpType extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('mp_type');
