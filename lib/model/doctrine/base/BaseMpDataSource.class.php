 ...
 * @method MpDataSource        setName()            Sets the current record's "name" value
 * @method MpDataSource        setDescription()     Sets the current record's "description" value
 * @method MpDataSource        setStatusId()        Sets the current record's "status_id" value
 * @method MpDataSource        setMpStatus()        Sets the current record's "MpStatus" value
 * @method MpDataSource        setDocumentRecords() Sets the current record's "DocumentRecords" collection
 * @method MpDataSource        setBulkUploads()     Sets the current record's "BulkUploads" collection
 * 
 * @package    MP
 * @subpackage model
 * @author     abas rafiq
 ...
 */
abstract class BaseMpDataSource extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('mp_data_source');
